...
describe('get_channel_id() test', () =>
{
    ...
    it('should return correct channel for valid input', (done) =>
    {
        ...
        .then((id) =>
        {
            ...
            return vd.get_channel_id(`https://www.youtube.com/watch?v=Wqw6-EDyVLo`);
        })
        .then((id) =>
        {
            assert(id === `UCp5FzJIflZ6TjV-laJcG5Tw`);
            return vd.get_channel_id(`https://www.youtube.com/embed/Wqw6-EDyVLo`);
        })
        .then((id) =>
        {
            assert(id === `UCp5FzJIflZ6TjV-laJcG5Tw`);
            return vd.get_channel_id(`https://youtu.be/Wqw6-EDyVLo?t=1`);
        })
        .then((id) =>
        {
            assert(id === `UCp5FzJIflZ6TjV-laJcG5Tw`);
            return vd.get_channel_id
            (`https://www.youtube.com/watch?time_continue=1254&v=Wqw6-EDyVLo`);
        })
        .then((id) =>
        {
            assert(id === `UCp5FzJIflZ6TjV-laJcG5Tw`);
